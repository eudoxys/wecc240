...
-----
    ...
    python3 aggregate_total.py [--debug] [--refresh] YEAR ...
...
To get the aggregate total data for 2020 run the command

    python3 aggregate_total.py 2020
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Syntax: python3 aggregate_total.py [--debug] [--refresh] YEAR",file=sys.stderr)
        year = 2020
    ...
    print("------------------")
    print(f"Peak total......... {total.max()/1000:.1f} GW")
    ...
    result[sorted(result.columns)].to_csv("wecc240_2020_total.csv",index=True,header=True)
