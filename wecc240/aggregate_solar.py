...
file = f"{os.environ['HOME']}/Downloads/aggregate_node_solar_production.csv"
if os.path.exists(file):
    ...
    data[sorted(data.columns)].round(3).to_csv("wecc240_2025_solar.csv",index=True,header=True)
else:
