...
def _(mo):
    mo.md(r"""
    This notebook reviews the `county_node_cf.csv` data.
    """)
    return


@app.cell
def _(mo, read_county_node_cf):
    data = read_county_node_cf().set_index("timestamp")
...
@app.cell
def _(help_md, mo, read_county_node_cf):
    mo.accordion(help_md(read_county_node_cf))
    return
...
def _():
    ...
    from wecc240_data import read_county_node_cf, help_md

    return help_md, mo, plt, read_county_node_cf
