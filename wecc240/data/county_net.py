...
def _(mo):
    mo.md(r"""
    This notebook reviews the `county_net.csv` data
    """)
    return


@app.cell
def _(mo, read_county_net):
    data = read_county_net().set_index("timestamp")
...
@app.cell
def _(help_md, mo, read_county_net):
    mo.accordion(help_md(read_county_net))
    return
...
def _():
    ...
    from wecc240_data import read_county_net, help_md

    return help_md, mo, plt, read_county_net
